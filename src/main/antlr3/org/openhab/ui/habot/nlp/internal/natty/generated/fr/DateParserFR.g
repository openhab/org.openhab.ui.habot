parser grammar DateParserFR;

options {
  tokenVocab=DateLexerFR;
  output=AST;
}

import NumericRulesFR;
...
alternative_day_of_month_list
  ...
  : ((relaxed_day_of_week? relaxed_day_of_month WHITE_SPACE relaxed_month (conjunction relaxed_day_of_month)+) (date_time_separator explicit_time)?)
